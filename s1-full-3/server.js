...
// Dashboard — serve o HTML sem middleware (auth feita pelo JS da página)
...
app.post('/api/auth/login', (req, res) => {
  ...
  // Também retorna o token para salvar no localStorage (fallback para nova aba)
  res.json({ ok: true, role: user.role, username: user.username, token });
});
